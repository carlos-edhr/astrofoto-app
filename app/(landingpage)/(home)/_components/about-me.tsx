...
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar"; // Optional avatar
 ...
 */
export function AboutMe({ name, role, avatarUrl, aboutText }: AboutMeProps) {
  return (
    <Card className="mx-auto w-full max-w-md rounded-lg shadow-sm">
      ...
      <CardContent className="mt-4 space-y-4">
        <p className="text-sm leading-relaxed text-gray-700">{aboutText}</p>
      </CardContent>
