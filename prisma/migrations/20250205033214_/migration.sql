...
-- CreateIndex
CREATE UNIQUE INDEX "SubscriptionLimit_userId_key" ON "SubscriptionLimit"("userId");
...
-- CreateIndex
CREATE UNIQUE INDEX "UserSubscription_stripe_subscription_key" ON "UserSubscription"("stripe_subscription");

-- CreateIndex
CREATE INDEX "Purchase_streamId_idx" ON "Purchase"("streamId");

-- CreateIndex
CREATE UNIQUE INDEX "Purchase_userId_streamId_key" ON "Purchase"("userId", "streamId");
